...
public:
       ...
       void showSingleBoundary () {
            ...
            cout<<"Computer Science and Engineering, DSATM";
            for (int i=0; i<10; i++) {
                cout<<'\xB0';
            }
       ...
       void welcomeScreen () {
            ...
            cout<<" 6th Semester Project  ";
            SetConsoleTextAttribute(hConsole, 12);           //Red Color Code=12
            gotoxy(1,6);
            cout<<"Submitted By: Chaitra Ravi & Lata";
            gotoxy(46,8);
            cout<<"Submitted To: ";
            ...
            cout<<"Please press Any Number to Play: ";
       }
